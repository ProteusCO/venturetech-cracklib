        ...
        for (int i = 0; i < control.length(); i++)
        {
            switch (control.charAt(i))
            {
                ...
                case RULE_PREPEND :
                    ...
                    {
                        throw new IllegalArgumentException(
                                "mangle: prepend missing argument in :"
                                        + control);
                    }
                    else
                    {
                ...
                case RULE_EXTRACT :
                    ...
                    {
                        throw new IllegalArgumentException(
                                "mangle: extract missing argument in :"
                                        + control);
                    }
                    else
                    {
                        ...
                        {
                            throw new IllegalArgumentException(
                                    "mangle: extract: weird argument in :"
                                            + control);
                        }
                ...
                case RULE_OVERSTRIKE :
                    ...
                    {
                        throw new IllegalArgumentException(
                                "mangle: overstrike missing argument in :"
                                        + control);
                    }
                    else
                    {
                        ...
                        {
                            throw new IllegalArgumentException(
                                    "mangle: overstrike weird argument in :"
                                            + control);
                        }
                ...
                case RULE_INSERT :
                    ...
                    {
                        throw new IllegalArgumentException(
                                "mangle: insert missing argument in :"
                                        + control);
                    }
                    else
                    {
                        ...
                        {
                            throw new IllegalArgumentException(
                                    "mangle: insert weird argument in :"
                                            + control);
                        }
                ...
                case RULE_PURGE : /* @x or @?c */
                    if (i == control.length()
                            || (control.charAt(i + 1) == RULE_CLASS && i == control
                                    .length() - 2))
                    {
                        throw new IllegalArgumentException(
                                "mangle: delete missing argument in :"
                                        + control);
                    }
                ...
                case RULE_SUBSTITUTE : /* sxy || s?cy */
                    ...
                    {
                        s = s.replace(control.charAt(i + 1), control
                                .charAt(i + 2));
                        i += 2;
                    }
                    else
                    {
                        s = replace(s, control.charAt(i + 2), control
                                .charAt(i + 3));
                        i += 3;
                    }
                    break;
                ...
                case RULE_MLAST :
                    ...
                    else
                    {
                        ...
                        {
                            i += 2;
                            if (!matchClass(control.charAt(i), s.charAt(s
                                    .length() - 1)))
                            {
                                return null;
                            }
